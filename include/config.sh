...
openssl_filename_url="https://www.openssl.org/source/openssl-1.1.1f.tar.gz"
#apache2.4
...
#mariadb5.5
mariadb5_5_filename="mariadb-5.5.67"
#mariadb10.0
mariadb10_0_filename="mariadb-10.0.38"
#mariadb10.1
mariadb10_1_filename="mariadb-10.1.44"
#mariadb10.2
mariadb10_2_filename="mariadb-10.2.31"
#mariadb10.3
mariadb10_3_filename="mariadb-10.3.22"
#mariadb10.4
mariadb10_4_filename="mariadb-10.4.12"
#percona5.5
percona5_5_filename="Percona-Server-5.5.62-38.14"
#percona5.6
percona5_6_filename="Percona-Server-5.6.47-87.0"
#percona5.7
percona5_7_filename="Percona-Server-5.7.29-32"
#percona8.0
...
#php7.2
php7_2_filename="php-7.2.29"
php7_2_filename_url="https://www.php.net/distributions/php-7.2.29.tar.gz"
#php7.3
php7_3_filename="php-7.3.16"
php7_3_filename_url="https://www.php.net/distributions/php-7.3.16.tar.gz"
#phpMyAdmin
...
#swoole
swoole_filename="swoole-src-4.4.16"
swoole_filename_url="https://github.com/swoole/swoole-src/archive/v4.4.16.tar.gz"
set_hint ${swoole_filename} "php-swoole-4.4.16"
#yaf
